...
def process_n_grams(
    ...
    if byQuarter:
        for word, yearDict in ngram_results.items():
            for _year_template, monthDict in yearDict.items():
                q1Sum, q2Sum, q3Sum, q4Sum = 0, 0, 0, 0
                for month_template, _freqDict in monthDict.items():
        ...
        for word in search_keywords_list:
            ...
            for y in yearList:
                ...
                if byQuarter:
                    ...
                    _q1Sum, _q2Sum, _q3Sum, _q4Sum = 0, 0, 0, 0
    ...
    for file in inputDocs:
        ...
        if within_sentence_co_occurrence_search_var:
            ...
            for sentIndex, sentence in enumerate(sentences):
                ...
                round((sentIndex / len_sentences), 2)
