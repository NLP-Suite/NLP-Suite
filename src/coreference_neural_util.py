# Neural coreference resolution engine for the Coreference GUI (coreference_main.py).
#   - fastcoref (LingMess / F-coref, a BERT/SpanBERT-based neural model) -> the 'BERT' option
# (coreferee, the former 'spaCy' option, was removed: it pins spacy<3.6 and broke the installer build.)
#
# It mirrors the contract of Stanza_util.Stanza_coref: returns (corefed_files, errorFound)
