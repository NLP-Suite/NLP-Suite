...
pydict["Find non-related documents"] = ["corpus_checker_PCACE_data_main.py", 1]
...
pydict["Similarities between documents (via TF-IDF)"] = ["corpus_checker_PCACE_data_main.py", 1]
