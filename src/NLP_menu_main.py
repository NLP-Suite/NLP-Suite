...
pydict["File search (file content for n-grams & co-occurrences; N-grams viewer)"] = ["NGrams_CoOccurrences_main.py", 1]
...
pydict["Animated time-dependent bar plot (Plotly)"] = ["data_visualization_1_main.py", 1]
pydict["Boxplot"] = ["data_visualization_2_main.py", 1]
pydict["Multiple bar charts"] = ["data_visualization_2_main.py", 1]
pydict["Network graphs (Gephi)"] = ["data_visualization_1_main.py", 1]
pydict["Sankey flowchart (Plotly)"] = ["data_visualization_1_main.py", 1]
pydict["Sunburst pie chart (Plotly)"] = ["data_visualization_1_main.py", 1]
pydict["Treemap (Plotly)"] = ["data_visualization_1_main.py", 1]
...
pydict["Search text file(s) for n-grams & co-occurrences (N-grams viewer)"] = ["NGrams_CoOccurrences_main.py", 1]
