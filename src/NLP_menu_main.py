...
pydict["File cleaner (Add full stop (.) at the end of lines without end-of-line marker)"] = ["file_checker_converter_cleaner_main.py", 1]
...
pre_processing_menu = tk.OptionMenu(window, pre_processing_tools_var,
                                    ...
                                    'File cleaner (Add full stop (.) at the end of lines without end-of-line marker)',
