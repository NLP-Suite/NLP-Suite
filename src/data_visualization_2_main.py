...
extra_GUIs_menu_var.set('')
extra_GUIs_menu = tk.OptionMenu(window,extra_GUIs_menu_var,'Data manipulation', 'Visualize categorical and network data: Gephi, Sankey, Colormap, Sunburst, Treemap (Open GUI)', 'Texts to maps (Open GUI)', 'Google Earth Pro (Open GUI)', 'HTML annotator (Open GUI)', 'Wordclouds (Open GUI)')
