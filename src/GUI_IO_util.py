...
msg_IO_config="The default or alternative config file should look something like this:\n"\
                                   "\nEMPTY LINE"\
                                   "\nC:/Users/Desktop/CORPUS DATA/Harry Potter/Book1.txt"\
                                   "\nEMPTY LINE"\
                                   "\nEMPTY LINE"\
                                   "\nEMPTY LINE"\
                                   ...
                                   "\nThe SECOND line is where a file name with its path would be placed;"\
                                   "\nThe THIRD line contains the directory where the set of files of your corpus are placed;"\
                                   "\nThe FOURTH line, EMPTY LINE, contains a rarely used secondary directory for input files;"\
                                   "\nThe FIFTH line, EMPTY LINE, could contains the output filenames; currently this is generated in the various algorithms;"\
