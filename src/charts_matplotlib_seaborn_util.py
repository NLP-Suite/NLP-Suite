...
def MALLET_heatmap(composition_file, topics_file, outputDir, fig_set={"figure.figsize": (8, 6), "figure.dpi": 300}, show_topics=True):
    ...
    try:
        ...
        topics = pd.read_csv(topics_file, names=["Topic", "Weight", "Keys"], encoding="ISO-8859-1",on_bad_lines='skip')  # Topic keys file
    ...
    heatmap = sns.heatmap(composition.iloc[:, 1:],      # Select all columns excluding index column
