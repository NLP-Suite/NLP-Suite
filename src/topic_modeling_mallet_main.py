...
TIPS_options = 'Topic modeling in Mallet', 'Mallet installation', 'JAVA installation', 'Excel - Enabling Macros', \
               'csv files - Problems & solutions', 'Topic modeling in Gensim', 'Topic modeling and corpus size'
