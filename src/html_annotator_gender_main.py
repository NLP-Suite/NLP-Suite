...
if IO_libraries_util.install_all_Python_packages(GUI_util.window,"html_annotator_gender_main.py",['os','tkinter','datetime'])==False:
    sys.exit(0)
