...
def run(inputFilename, inputDir, outputDir, openOutputFiles, createCharts, chartPackage,
    ...
    error, package, parsers, package_basics, language, package_display_area_value, encoding_var, export_json_var, timeout_var, memory_var, document_length_var, limit_sentence_length_var = \
        ...
        if parser_var or (annotators_var and annotators_menu_var != ''):
            ...
            if len(annotator)>0:
                tempOutputFiles = Stanford_CoreNLP_util.CoreNLP_annotate(config_filename, inputFilename, inputDir,
                                                                               ...
                                                                               language, export_json_var, timeout_var, memory_var, document_length_var, limit_sentence_length_var,
