...
def get_list_item():
    list_item=None
    # check path value in config file
    if str(config_input_output_alphabetic_options[0][1])!='': # input file
        list_item = 0
    if str(config_input_output_alphabetic_options[1][1])!='': # input dir
        list_item = 1
...
def set_default_options():
    ...
    # set date format
    if config_input_output_alphabetic_options[list_item][4] != '' and config_input_output_alphabetic_options[list_item][
        4] != "0":
        filename_embeds_date_var.set(1)
    ...
    # set date position
    if config_input_output_alphabetic_options[list_item][5] != '' and config_input_output_alphabetic_options[list_item][
        5] != "0":
...
# HELP buttons --------------------------------------------------------------------------
    ...
    if config_input_output_numeric_options[0]==1:
        y_multiplier_integer = GUI_IO_util.place_help_button(window, help_button_x_coordinate, y_multiplier_integer, "NLP Suite Help",
                                      GUI_IO_util.msg_CoNLL + GUI_IO_util.msg_save_uponClose)
    elif config_input_output_numeric_options[0]==2:
        y_multiplier_integer = GUI_IO_util.place_help_button(window, help_button_x_coordinate, y_multiplier_integer, "NLP Suite Help",
                                      GUI_IO_util.msg_txtFile + GUI_IO_util.msg_save_uponClose)
    elif config_input_output_numeric_options[0]==3:
        y_multiplier_integer = GUI_IO_util.place_help_button(window, help_button_x_coordinate, y_multiplier_integer, "NLP Suite Help",
                                      GUI_IO_util.msg_csvFile + GUI_IO_util.msg_save_uponClose)
    elif config_input_output_numeric_options[0] == 4:
        y_multiplier_integer = GUI_IO_util.place_help_button(window, help_button_x_coordinate, y_multiplier_integer, "NLP Suite Help",
                                      GUI_IO_util.msg_anyFile + GUI_IO_util.msg_save_uponClose)
    elif config_input_output_numeric_options[0]==5:
        y_multiplier_integer = GUI_IO_util.place_help_button(window, help_button_x_coordinate, y_multiplier_integer, "NLP Suite Help",
                                      GUI_IO_util.msg_txt_htmlFile + GUI_IO_util.msg_save_uponClose)
    elif config_input_output_numeric_options[0]==6:
        y_multiplier_integer = GUI_IO_util.place_help_button(window, help_button_x_coordinate, y_multiplier_integer, "NLP Suite Help",
                                      GUI_IO_util.msg_csv_txtFile + GUI_IO_util.msg_save_uponClose)

    # INPUT primary directory
    if config_input_output_numeric_options[1]!=0:
        y_multiplier_integer = GUI_IO_util.place_help_button(window, help_button_x_coordinate, y_multiplier_integer, "NLP Suite Help",
                                      "Please, select the main INPUT directory of the TXT files to be analyzed." + GUI_IO_util.msg_openExplorer + GUI_IO_util.msg_save_uponClose)

    # INPUT secondary directory
    if config_input_output_numeric_options[2]!=0:
        y_multiplier_integer = GUI_IO_util.place_help_button(window, help_button_x_coordinate, y_multiplier_integer, "NLP Suite Help",
                                      "Please, select the secondary INPUT directory of the TXT files to be analyzed." + GUI_IO_util.msg_openExplorer + GUI_IO_util.msg_save_uponClose)

    # OUTPUT  directory
    y_multiplier_integer = GUI_IO_util.place_help_button(window, help_button_x_coordinate, y_multiplier_integer, "NLP Suite Help",
                                  GUI_IO_util.msg_outputDirectory + GUI_IO_util.msg_save_uponClose)
    ...
    y_multiplier_integer = GUI_IO_util.place_help_button(window,help_button_x_coordinate,y_multiplier_integer,"NLP Suite Help",
                   ...
                   '\n   the second filename of a State of the Union address by a United States president contains three items: type of speech (e.g., sotu as opposed to ina, inaugural), president, date of delivery separated by the # sign.'
                    ...
                    'IF YOU WANT TO SORT BY A SPECIFIC ITEMS (e.g., 4), JUST ENTER 4 AND THE OTHER ITEMS WILL BE ADDED AUTOMATICALLY IN THE ORDER THEY OCCUPY IN THE FILENAME.' + GUI_IO_util.msg_save_uponClose)
...
def get_IO_options_str():
    ...
    input_output_options = GUI_util.inputFilename.get() + ', ' + \
                    GUI_util.input_main_dir_path.get() + ', ' + \
                    GUI_util.input_secondary_dir_path.get() + ', ' + \
                    GUI_util.output_dir_path.get()
    IO_options_str = IO_options_str + ', ' + input_output_options
...
# input file
    ...
    # enter data in path field of config file
    if GUI_util.inputFilename.get()!='':
        GUI_util.inputFilename.set(GUI_util.inputFilename.get() + date_label)
        inputFilename_list.append(GUI_util.inputFilename.get() + date_label)
    else:
...
# input main dir
    ...
    if GUI_util.input_main_dir_path.get()!='':
        ...
        inputDir_list.append(GUI_util.input_main_dir_path.get() + date_label)
    else:
