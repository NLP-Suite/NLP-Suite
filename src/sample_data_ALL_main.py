...
sample_sentences_button = tk.Button(window, text='Sample sentences in txt file(s) via word searches (Open GUI)',width=70,command=lambda: call("python search_ALL_main.py", shell=True))
...
def help_buttons(window,help_button_x_coordinate,y_multiplier_integer):
    ...
    y_multiplier_integer = GUI_IO_util.place_help_button(window,help_button_x_coordinate,y_multiplier_integer,"NLP Suite Help",
                                  "Please, click on the button to open the GUI for extracting sentences from a txt file by searching for specific words/collocations in the senetences.")
    y_multiplier_integer = GUI_IO_util.place_help_button(window, help_button_x_coordinate, y_multiplier_integer, "NLP Suite Help",
