...
y_multiplier_integer=GUI_IO_util.placeWidget(window,GUI_IO_util.get_labels_x_coordinate(),y_multiplier_integer, find_checkbox,True)

source_file_type_menu_lb = tk.Label(window, text='Source file type ')
y_multiplier_integer=GUI_IO_util.placeWidget(window,GUI_IO_util.get_labels_x_coordinate()+110,y_multiplier_integer,source_file_type_menu_lb,True)
...
y_multiplier_integer=GUI_IO_util.placeWidget(window,GUI_IO_util.get_labels_x_coordinate()+220,y_multiplier_integer,source_file_type_menu,True)

target_file_type_menu_lb = tk.Label(window, text='Target file type ')
y_multiplier_integer=GUI_IO_util.placeWidget(window,GUI_IO_util.get_labels_x_coordinate()+330,y_multiplier_integer,target_file_type_menu_lb,True)
...
y_multiplier_integer=GUI_IO_util.placeWidget(window,GUI_IO_util.get_labels_x_coordinate()+440,y_multiplier_integer,target_file_type_menu)
...
y_multiplier_integer=GUI_IO_util.placeWidget(window,GUI_IO_util.get_labels_x_coordinate()+20,y_multiplier_integer,matching_checkbox,True)

character_value_var.set('_')
character_lb = tk.Label(window, text='Separator character(s)')
y_multiplier_integer=GUI_IO_util.placeWidget(window,GUI_IO_util.get_labels_x_coordinate()+370,y_multiplier_integer, character_lb,True)
character_value = tk.Entry(window, width=2,textvariable=character_value_var)
character_value.configure(state="disabled")
y_multiplier_integer=GUI_IO_util.placeWidget(window,GUI_IO_util.get_labels_x_coordinate()+520,y_multiplier_integer, character_value,True)

number_of_items_lb = tk.Label(window, text='Number of items')
y_multiplier_integer=GUI_IO_util.placeWidget(window,GUI_IO_util.get_labels_x_coordinate()+560,y_multiplier_integer, number_of_items_lb,True)
...
y_multiplier_integer=GUI_IO_util.placeWidget(window,GUI_IO_util.get_labels_x_coordinate()+670,y_multiplier_integer, number_of_items_value,True)
...
y_multiplier_integer=GUI_IO_util.placeWidget(window,GUI_IO_util.get_labels_x_coordinate()+760,y_multiplier_integer, include_exclude_checkbox)
...
y_multiplier_integer=GUI_IO_util.placeWidget(window,GUI_IO_util.get_labels_x_coordinate()+20,y_multiplier_integer,copy_checkbox,True)
...
y_multiplier_integer=GUI_IO_util.placeWidget(window,GUI_IO_util.get_labels_x_coordinate()+200,y_multiplier_integer,move_checkbox)
