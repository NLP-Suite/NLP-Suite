...
def run(inputFilename, inputPath, outputPath, parser_menu_var, openOutputFiles, createExcelCharts, memory_var, compute_sentence, dateInclude, sep = "_", date_field_position = 3, dateFormat = "mm-dd-yyyy"):
    ...
    # message displayed in the parser
    # IO_util.timed_alert(GUI_util.window,3000,'Stanford CoreNLP start','Started running Stanford CoreNLP at',True,'You can follow CoreNLP in command line.')
    ...
    # message displayed in the parser
    # IO_util.timed_alert(GUI_util.window,3000,'Stanford CoreNLP end','Finished running Stanford CoreNLP at',True)
