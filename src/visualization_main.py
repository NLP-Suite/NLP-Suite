...
y_multiplier_integer=GUI_IO_util.placeWidget(GUI_IO_util.get_labels_x_coordinate() + 900,y_multiplier_integer,reset_button, True)

select_csv_field_dynamic_network_lb = tk.Label(window, text='Select csv file field for dynamic network graph')
y_multiplier_integer = GUI_IO_util.placeWidget(GUI_IO_util.get_labels_x_indented_coordinate()+300, y_multiplier_integer,
...
y_multiplier_integer = GUI_IO_util.placeWidget(GUI_IO_util.get_labels_x_indented_coordinate()+600, y_multiplier_integer,
