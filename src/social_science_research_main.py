...
def check_filename(output_dir_path):
	if IO_libraries_util.inputProgramFileCheck('file_checker_converter_cleaner_main.py') == False:
		return
	if platform == "win32":
		subprocess.call("python3file_manager_main.py", shell=True)
	# linux # OS X
...
def character(output_dir_path):
	if IO_libraries_util.inputProgramFileCheck('WordNet_main.py') == False:
		return
	if platform == "win32":
		subprocess.call("python3WordNet_main.py character", shell=True)
	# linux # OS X
	elif platform == "linux" or platform == "linux2" or platform == "darwin":
...
def find_character_home(output_dir_path):
	if IO_libraries_util.inputProgramFileCheck('file_classifier_main.py') == False:
		return
	if platform == "win32":
		subprocess.call("python3file_classifier_main.py character home", shell=True)
	# linux # OS X
	elif platform == "linux" or platform == "linux2" or platform == "darwin":
...
def ancestor(input_main_dir_path, output_dir_path):
	if IO_libraries_util.inputProgramFileCheck('WordNet_main.py') == False:
		return
	if platform == "win32":
		subprocess.call("python3WordNet.py ancestor", shell=True)
	# linux # OS X
	elif platform == "linux" or platform == "linux2" or platform == "darwin":
...
def Levenshtein():
	if IO_libraries_util.inputProgramFileCheck('file_spell_checker_main.py') == False:
		return
	if platform == "win32":
		subprocess.call("python3file_spell_checker_main.py", shell=True)
	# linux # OS X
	elif platform == "linux" or platform == "linux2" or platform == "darwin":
