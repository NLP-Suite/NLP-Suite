...
GUI_size, y_multiplier_integer, increment = GUI_IO_util.GUI_settings(IO_setup_display_brief,
                             ...
                             GUI_height_full=660, # height at full display
...
sample_by_string_button = tk.Button(window, text='Sample files by string in filename',width=GUI_IO_util.widget_width_medium,command=lambda: option_not_available())
y_multiplier_integer=GUI_IO_util.placeWidget(window,GUI_IO_util.labels_x_indented_coordinate,y_multiplier_integer,sample_by_string_button)
...
sample_sentences_button = tk.Button(window, text='Sample files by search word(s) (Open GUI)',width=GUI_IO_util.widget_width_medium,command=lambda: call("python file_search_byWord_main.py", shell=True))
# place widget with hover-over info
y_multiplier_integer = GUI_IO_util.placeWidget(window,GUI_IO_util.labels_x_indented_coordinate, y_multiplier_integer,
                                   sample_sentences_button,
                                   False, False, True, False, 90, GUI_IO_util.labels_x_coordinate,
                                   "Click on the button to open the GUI.\nClick on ?HELP button on this line to view the options the GUI offers.")
...
def help_buttons(window,help_button_x_coordinate,y_multiplier_integer):
    ...
    y_multiplier_integer = GUI_IO_util.place_help_button(window,help_button_x_coordinate,y_multiplier_integer,"NLP Suite Help",
                                  "Please, click on the button to sample your corpus by a specific string in the filename.")
    y_multiplier_integer = GUI_IO_util.place_help_button(window,help_button_x_coordinate,y_multiplier_integer,"NLP Suite Help",
    ...
    y_multiplier_integer = GUI_IO_util.place_help_button(window,help_button_x_coordinate,y_multiplier_integer,"NLP Suite Help",
                                  "Please, click on the button to open the GUI that, for selected words/collocations, will allow you:\n\n   1. to create a subcorpus of files containing the selected words;\n   2. to extract all the sentences containing the selected words.")
    y_multiplier_integer = GUI_IO_util.place_help_button(window,help_button_x_coordinate,y_multiplier_integer,"NLP Suite Help",
