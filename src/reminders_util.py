...
message_CoreNLP_coref_timing = "Beware that coreference resolution on the 296 files (2042312 words total) of the President of tthe United States inaugural and state of union speeches, takes approximately 3 hours on a standard laptop."

title_options_CoreNLP_SVO_timing = ['CoreNLP SVO timing']
message_CoreNLP_SVO_timing = "Beware that the SVO algorithms on the 296 files (2042312 words total) of the President of tthe United States inaugural and state of union speeches, takes approximately 3 hours on a standard laptop."

title_options_CoreNLP_SVO_gender_quote_timing = ['CoreNLP SVO + gender + quote timing']
message_CoreNLP_SVO_gender_quote_timing = "Beware that the SVO + gender + quote algorithms on the 296 files (2042312 words total) of the President of tthe United States inaugural and state of union speeches, takes approximately 4 hours on a standard laptop."

title_options_CoreNLP_gender_timing = ['CoreNLP gender timing']
message_CoreNLP_gender_timing = "Beware that the gender algortithm on the 296 files (2042312 words total) of the President of tthe United States inaugural and state of union speeches, takes approximately 3 hours on a standard laptop."

title_options_CoreNLP_quote_timing = ['CoreNLP quote timing']
message_CoreNLP_quote_timing = "Beware that the quote annotator on the 296 files (2042312 words total) of the President of tthe United States inaugural and state of union speeches, takes approximately 3 hours on a standard laptop."
