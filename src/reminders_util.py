...
title_options_Gensim_Word2Vec_timing = ['Gensim Word2Vec']
message_Gensim_Word2Vec_timing_timing = "Beware that Gensim Word2Vec on the 296 files (2042312 words total) of the President of the United States Inaugural and State of the Union speeches, with the tokenizing and lemmatzing options, takes approximately 3 hours on a standard laptop."
...
message_CoreNLP_parser_nn_timing = "Beware that the CoreNLP neural network parser algortithm on the 296 files (2042312 words total) of the President of the United States Inaugural and State of the Union speeches, takes approximately 1 hour and 40 minutes on a standard laptop."
