...
_shell_y_multiplier = y_multiplier_integer + 1  # restored before GUI_bottom so the window sizes to the shell
...
from_dataID_setupID_lb = tk.Label(query_tab, text='From data ID to setup ID ')
y_multiplier_integer=GUI_IO_util.placeWidget(query_tab,GUI_IO_util.labels_x_coordinate,y_multiplier_integer,from_dataID_setupID_lb,True)

from_dataID_setupID_objectType_var = tk.StringVar()
from_dataID_setupID_objectType_var.set('')
from_dataID_setupID_menu = tk.OptionMenu(query_tab, from_dataID_setupID_objectType_var, 'Complex', 'Simplex')
from_dataID_setupID_menu.configure(state='disabled')
# place widget with hover-over info
y_multiplier_integer = GUI_IO_util.placeWidget(query_tab,GUI_IO_util.IO_configuration_menu-50, y_multiplier_integer,
...
enter_data_ID_lb = tk.Label(query_tab, text='Enter data ID')
y_multiplier_integer=GUI_IO_util.placeWidget(query_tab,GUI_IO_util.open_reminders_x_coordinate,y_multiplier_integer,enter_data_ID_lb,True)

enter_data_ID = tk.Entry(query_tab,width=GUI_IO_util.widget_width_extra_short,textvariable=enter_data_ID_var)
enter_data_ID.configure(state="disabled")
# place widget with hover-over info

y_multiplier_integer = GUI_IO_util.placeWidget(query_tab,GUI_IO_util.open_reminders_x_coordinate+100,
    y_multiplier_integer,
    enter_data_ID, True, False, True, False, 90,
    GUI_IO_util.open_reminders_x_coordinate+100, "Enter the numeric data ID value")

setup_name = tk.Entry(query_tab,width=GUI_IO_util.widget_width_short,textvariable=setup_name_var,state='disabled')
# setup_name.configure(state="disabled")
# place widget with hover-over info

y_multiplier_integer = GUI_IO_util.placeWidget(query_tab,GUI_IO_util.open_setup_x_coordinate,
    y_multiplier_integer,
...
# FIRST checkbox ---------------------------------------------------
identifiers_checkbox = tk.Checkbutton(query_tab, text='', variable=identifiers_var, onvalue=1, offvalue=0, state='disabled')
# place widget with hover-over info
y_multiplier_integer = GUI_IO_util.placeWidget(query_tab,GUI_IO_util.open_reminders_x_coordinate-10, y_multiplier_integer,
...
# SECOND checkbox ---------------------------------------------------
extended_headers_checkbox = tk.Checkbutton(query_tab, text='', variable=extended_headers_var, onvalue=1, offvalue=0, state='disabled')
# place widget with hover-over info
y_multiplier_integer = GUI_IO_util.placeWidget(query_tab,GUI_IO_util.open_reminders_x_coordinate+10, y_multiplier_integer,
...
# THIRD checkbox ---------------------------------------------------
parents_children_checkbox = tk.Checkbutton(query_tab, text='', variable=parents_children_var, onvalue=1, offvalue=0, state='disabled')
# place widget with hover-over info
y_multiplier_integer = GUI_IO_util.placeWidget(query_tab,GUI_IO_util.open_reminders_x_coordinate+30, y_multiplier_integer,
...
document_sources_checkbox = tk.Checkbutton(query_tab, text='', variable=document_sources_var, onvalue=1, offvalue=0, state='disabled')

# place widget with hover-over info
y_multiplier_integer = GUI_IO_util.placeWidget(query_tab,GUI_IO_util.open_reminders_x_coordinate+50, y_multiplier_integer,
...
comments_var.set(0)
comments_checkbox = tk.Checkbutton(query_tab, text='', variable=comments_var, onvalue=1, offvalue=0, state='disabled')

# place widget with hover-over info
y_multiplier_integer = GUI_IO_util.placeWidget(query_tab,GUI_IO_util.open_reminders_x_coordinate+70, y_multiplier_integer,
                                   comments_checkbox,
                                   True, False, True, False, 90, GUI_IO_util.open_TIPS_x_coordinate,
...
comments_type_var.set('')
comments_menu = tk.OptionMenu(query_tab, comments_type_var, '*', 'Users comments', 'Verifiers comments')
comments_menu.configure(state='disabled')
# place widget with hover-over info
y_multiplier_integer = GUI_IO_util.placeWidget(query_tab,GUI_IO_util.open_reminders_x_coordinate+95, y_multiplier_integer,
                                   comments_menu,
                                   True, False, True, False, 90, GUI_IO_util.open_TIPS_x_coordinate,
...
simplex_export_values_checkbox = tk.Checkbutton(query_tab, text='', variable=simplex_export_values_var, onvalue=1, offvalue=0, state='disabled')
y_multiplier_integer = GUI_IO_util.placeWidget(query_tab, GUI_IO_util.open_reminders_x_coordinate-10, y_multiplier_integer,
...
simplex_charts_checkbox = tk.Checkbutton(query_tab, text='', variable=simplex_charts_var, onvalue=1, offvalue=0, state='disabled')
y_multiplier_integer = GUI_IO_util.placeWidget(query_tab, GUI_IO_util.open_reminders_x_coordinate+10, y_multiplier_integer,
...
simplex_timechart_checkbox = tk.Checkbutton(query_tab, text='', variable=simplex_timechart_var, onvalue=1, offvalue=0, state='disabled')
y_multiplier_integer = GUI_IO_util.placeWidget(query_tab, GUI_IO_util.open_reminders_x_coordinate+30, y_multiplier_integer,
...
simplex_GIS_checkbox = tk.Checkbutton(query_tab, text='', variable=simplex_GIS_var, onvalue=1, offvalue=0, state='disabled')
...
simplex_value_type_lb = tk.Label(query_tab, text='Simplex data type ')
y_multiplier_integer=GUI_IO_util.placeWidget(query_tab,GUI_IO_util.labels_x_indented_coordinate,y_multiplier_integer,simplex_value_type_lb,True)

simplex_value_type_var= tk.StringVar()
simplex_value_type_menu = tk.OptionMenu(query_tab, simplex_value_type_var, 'text','date', 'number')
...
simplex_value = ttk.Combobox(query_tab, textvariable = simplex_value_var, width=GUI_IO_util.widget_width_short)
...
# place widget with hover-over info
y_multiplier_integer = GUI_IO_util.placeWidget(query_tab,GUI_IO_util.open_reminders_x_coordinate, y_multiplier_integer,
                                   simplex_value,
...
value_parent_object_checkbox = tk.Checkbutton(query_tab, text='Get simplex/complex objects of selected data type (& value)', variable=value_parent_object_var, onvalue=1, offvalue=0)
# place widget with hover-over info
y_multiplier_integer = GUI_IO_util.placeWidget(query_tab,GUI_IO_util.open_setup_x_coordinate+150, y_multiplier_integer,
...
search_simplex_lb = tk.Label(query_tab, text='Search simplex value')
y_multiplier_integer=GUI_IO_util.placeWidget(query_tab,GUI_IO_util.labels_x_indented_coordinate,y_multiplier_integer,search_simplex_lb,True)

search_simplex_var = tk.StringVar()
search_simplex_entry = tk.Entry(query_tab, textvariable=search_simplex_var, width=20, state='disabled')
y_multiplier_integer = GUI_IO_util.placeWidget(query_tab,GUI_IO_util.IO_configuration_menu-50, y_multiplier_integer,
...
search_simplex_results_lb = tk.Label(query_tab, text='Search results')
y_multiplier_integer=GUI_IO_util.placeWidget(query_tab,GUI_IO_util.open_setup_x_coordinate,y_multiplier_integer,search_simplex_results_lb,True)

search_simplex_results_var = tk.StringVar()
search_simplex_results = ttk.Combobox(query_tab, textvariable=search_simplex_results_var, width=GUI_IO_util.widget_width_short)
...
# Tab content is .place'd inside the frames; re-enable grid so GUI_bottom finalizes the SHELL columns,
# and restore the shell's row so the window sizes to the top rows + notebook (not the tab-local rows).
# TODO: per-tab ? HELP via tab_help(); the window-level help_buttons() column no longer aligns with tabs.
GUI_IO_util.grid_layout_enabled = True
