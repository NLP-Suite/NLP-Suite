...
y_multiplier_integer=GUI_util.y_multiplier_integer+ 2 #1
...
pydict["Search words/collocations by sentence index"] = ["search_byWord_main.py",1]
...
# TIPS_lookup = {'CoNLL Table':"TIPS_NLP_Stanford CoreNLP CoNLL table.pdf",'POSTAG (Part of Speech Tags)':"TIPS_NLP_POSTAG (Part of Speech Tags) Stanford CoreNLP.pdf",'DEPREL (Stanford Dependency Relations)':"TIPS_NLP_DEPREL (Dependency Relations) Stanford CoreNLP.pdf",'Noun Analysis':"TIPS_NLP_Noun Analysis.pdf",'Verb Analysis':"TIPS_NLP_Verb Analysis.pdf",'Function Words Analysis':'TIPS_NLP_Function Words Analysis.pdf','Clausal Analysis':'TIPS_NLP_Clausal analysis.pdf','Java download install run':'TIPS_NLP_Java download install run.pdf'}
# TIPS_options= 'Clausal Analysis','Noun Analysis', 'Verb Analysis', 'Function Words Analysis', 'CoNLL Table', 'POSTAG (Part of Speech Tags)', 'DEPREL (Stanford Dependency Relations)','Java download install run'

TIPS_lookup = {'Clausal analysis':'TIPS_NLP_Clausal Analysis.pdf','Sentence complexity':'TIPS_NLP_Sentence complexity.pdf','Text readability':'TIPS_NLP_Text readability.pdf','CoNLL Table': "TIPS_NLP_Stanford CoreNLP CoNLL table.pdf", 'POSTAG (Part of Speech Tags)': "TIPS_NLP_POSTAG (Part of Speech Tags) Stanford CoreNLP.pdf", 'DEPREL (Stanford Dependency Relations)': "TIPS_NLP_DEPREL (Dependency Relations) Stanford CoreNLP.pdf", 'NLP Searches': "TIPS_NLP_NLP Searches.pdf",'N-Grams (word & character)':"TIPS_NLP_Ngrams (word & character).pdf",'NLP Ngram and Word Co-Occurrence VIEWER':"TIPS_NLP_NLP Ngram and Word Co-Occurrence VIEWER.pdf",'Google Ngram Viewer':'TIPS_NLP_Google Ngram Viewer.pdf'}
TIPS_options='Clausal analysis', 'Sentence complexity', 'Text readability','CoNLL Table', 'POSTAG (Part of Speech Tags)', 'DEPREL (Stanford Dependency Relations)','NLP Searches','N-Grams (word & character)','NLP Ngram and Word Co-Occurrence VIEWER','Google Ngram Viewer'
