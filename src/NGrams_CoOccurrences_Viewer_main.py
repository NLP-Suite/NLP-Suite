...
# VIEWER ____________________________________________________________________________________________
    ...
    if search_words == '' and (n_grams_viewer_var == True or CoOcc_Viewer_var == True):
        mb.showwarning(title='Warning',
                       message="You have selected to run a Viewer but you have not enetered any search strings in the Search widget.\n\nPlease, enter search values  and try again.")
        return
...
n_grams_options_menu = tk.OptionMenu(window, n_grams_options_menu_var, 'Hapax legomena (unigrams)','Normalize n-grams', 'Exclude punctuation (word n-grams only)','By sentence index','Repetition of words (last N words of a sentence/first N words of next sentence)','Repetition of words across sentences (special ngrams)')
...
TIPS_lookup = {'N-Grams (word & character)':"TIPS_NLP_Ngrams (word & character).pdf",'NLP Ngram and Word Co-Occurrence VIEWER':"TIPS_NLP_NLP Ngram and Word Co-Occurrence VIEWER.pdf",'Google Ngram Viewer':'TIPS_NLP_Google Ngram Viewer.pdf','Java download install run':'TIPS_NLP_Java download install run.pdf'}
TIPS_options='N-Grams (word & character)','NLP Ngram and Word Co-Occurrence VIEWER','Google Ngram Viewer','Java download install run'
