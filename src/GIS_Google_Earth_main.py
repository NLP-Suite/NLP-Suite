...
if IO_libraries_util.install_all_packages(GUI_util.window,"GIS",['os','pandas','tkinter','numpy','tkcolorpicker','PIL'])==False:
	sys.exit(0)
...
TIPS_lookup = {"Google Earth Pro": "TIPS_NLP_Google Earth Pro.pdf",
