...
extra_GUIs_menu = GUI_theme_util.create_option_menu(window,variable=extra_GUIs_menu_var,values=['Semantic analysis (Open GUI)','Parsers & annotators (Open GUI)','N-grams & Co-Occurrences (Open GUI)','CoNLL table analyzer (Open GUI)','WordNet (Open GUI)','What\'s in Your Corpus (Open GUI)'])
...
check_nom_verb_ending_checkbox = GUI_theme_util.create_checkbox(window, variable=check_nom_verb_ending_var, onvalue=1, offvalue=0)
check_nom_verb_ending_checkbox.configure(text="Check the nominalized verb ending")
# place widget with hover-over info
