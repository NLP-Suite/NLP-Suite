...
#@@@
# if IO_libraries_util.install_all_Python_packages(GUI_util.window,"topic_modeling_main.py",['nltk','os','tkinter','multiprocessing','pandas','gensim','spacy','pyLDAvis','matplotlib','logging','IPython','bertopic'])==False:
#     sys.exit(0)

if IO_libraries_util.install_all_Python_packages(GUI_util.window,"topic_modeling_main.py",['nltk','os','tkinter','multiprocessing','pandas','gensim','spacy','pyLDAvis','matplotlib','logging','IPython'])==False:
    sys.exit(0)
